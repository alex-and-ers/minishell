...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/02 15:59:13 by aserebry          #+#    #+#             */
/*   Updated: 2024/03/05 14:36:15 by aserebry         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static DIR	*cmd_checks(t_cmd *prompt, t_list *cmd, char ***s, char *path)
{
	t_mini	*n;
	DIR		*dir;
...
void	get_cmd(t_cmd *prompt, t_list *cmd, char **s, char *path)
{
	t_mini	*n;
	DIR		*dir;
