...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/02 16:01:22 by aserebry          #+#    #+#             */
/*   Updated: 2024/03/05 13:03:47 by aserebry         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*child_process(t_cmd *prompt, t_list *cmd, int fd[2])
{
	t_mini	*n;
	int		l;
...
void	exec_fork(t_cmd *prompt, t_list *cmd, int fd[2])
{
	pid_t	pid;
