...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/02 16:00:44 by aserebry          #+#    #+#             */
/*   Updated: 2024/03/05 13:04:02 by aserebry         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell.h"

static char	**split_all(char **args, t_cmd *prompt)
{
	char	**subsplit;
	int		i;
	int		quotes[2];
...
static void	*parse_args(char **args, t_cmd *p)
{
	int	is_exit;
	int	i;
